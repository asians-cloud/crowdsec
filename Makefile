...
LD_OPTS_VARS= \
-X 'github.com/asians-cloud/go-cs-lib/version.Version=$(BUILD_VERSION)' \
-X 'github.com/asians-cloud/go-cs-lib/version.BuildDate=$(BUILD_TIMESTAMP)' \
-X 'github.com/asians-cloud/go-cs-lib/version.Tag=$(BUILD_TAG)' \
