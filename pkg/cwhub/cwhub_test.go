...
func resetResponseByPath() {
	responseByPath = map[string]string{
		"/master/parsers/s01-parse/asians-cloud/foobar_parser.yaml":    fileToStringX("./testdata/foobar_parser.yaml"),
		"/master/parsers/s01-parse/asians-cloud/foobar_subparser.yaml": fileToStringX("./testdata/foobar_parser.yaml"),
		"/master/collections/asians-cloud/test_collection.yaml":        fileToStringX("./testdata/collection_v1.yaml"),
		"/master/.index.json": fileToStringX("./testdata/index1.json"),
		"/master/scenarios/asians-cloud/foobar_scenario.yaml": `filter: true
name: asians-cloud/foobar_scenario`,
		"/master/scenarios/asians-cloud/barfoo_scenario.yaml": `filter: true
name: asians-cloud/foobar_scenario`,
		"/master/collections/asians-cloud/foobar_subcollection.yaml": `
blah: blalala
qwe: jejwejejw`,
		"/master/collections/asians-cloud/foobar.yaml": `
blah: blalala
qwe: jejwejejw`,
	}
}
