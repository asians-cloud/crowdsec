...
func NewParsersCmd() *cobra.Command {
	var cmdParsers = &cobra.Command{
		...
		Example: `cscli parsers install asians-cloud/sshd-logs
cscli parsers inspect asians-cloud/sshd-logs
cscli parsers upgrade asians-cloud/sshd-logs
cscli parsers list
cscli parsers remove asians-cloud/sshd-logs
`,
...
cscli parser list asians-cloud/xxx`,
		DisableAutoGenTag: true,
		Run: func(cmd *cobra.Command, args []string) {
