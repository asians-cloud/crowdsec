...
func NewPostOverflowsCmd() *cobra.Command {
	cmdPostOverflows := &cobra.Command{
		...
		Example: `cscli postoverflows install asians-cloud/cdn-whitelist
		cscli postoverflows inspect asians-cloud/cdn-whitelist
		cscli postoverflows upgrade asians-cloud/cdn-whitelist
		cscli postoverflows list
		cscli postoverflows remove asians-cloud/cdn-whitelist`,
...
cscli postoverflows list asians-cloud/xxx`,
		DisableAutoGenTag: true,
		Run: func(cmd *cobra.Command, args []string) {
